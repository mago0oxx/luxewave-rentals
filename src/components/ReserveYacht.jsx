...
import emailjs from 'emailjs-com';
import Spinner from './Spinner';
// 🚀 Se importan las funciones de Firebase para invocar la Cloud Function
...
export default function ReserveYacht() {
  ...
  // 👉 Esta función ahora invoca la Cloud Function usando httpsCallable
  const handlePayment = async () => {
    setLoading(true);
    setError("");
    ...
    try {
      // Obtiene la instancia de Functions y la función invocable
      const functionsInstance = getFunctions();
      const createStripeCheckout = httpsCallable(functionsInstance, 'createStripeCheckout');

      // Invoca la función pasando los parámetros necesarios
